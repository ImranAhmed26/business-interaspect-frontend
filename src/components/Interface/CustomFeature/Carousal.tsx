...
import { projectData } from '@/constants/landingPage';
...
export default function Carousel() {
  return (
    ...
    >
      ...
      <div className='relative max-w-6xl mx-auto bg-gray-300/40 dark:bg-gray-900/70 backdrop-blur-2xl rounded-3xl drop-shadow-md overflow-hidden'>
        <Swiper
          modules={[Navigation]}
          className='mySwiper'
          spaceBetween={30}
